...
public class HitRatioBenchmark implements Benchmark {
    ...
    public HitRatioBenchmark(BenchmarkContext benchmarkContext, BenchmarkParameters benchmarkParameters) {
    ...
    public void run() {
        ...
        System.out.printf("Expected hr(num)=%f, hr(byte)=%f\n",
                pagesHit / (double) cachePages, bytesHit / (double) cacheBytes);
