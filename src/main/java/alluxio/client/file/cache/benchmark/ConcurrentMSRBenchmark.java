...
public class ConcurrentMSRBenchmark {
  private static final int NUM_UNIQUE_ENTRY = 32 * Constants.KB;
  ...
  public static void main(String[] args) {
    ...
    ConcurrentClockCuckooFilter<PageId> clockFilter =
        ConcurrentClockCuckooFilter.create(ShadowCache.PageIdFunnel.FUNNEL, NUM_UNIQUE_ENTRY,
    ...
    while (dataset.hasNext()) {
      ...
      clockFilter.increaseOperationCount(1);
      ...
      if (cnt % (WINDOW_SIZE >> (BITS_PER_CLOCK + 2)) == 0) {
        System.out.println(
            cnt + "\t" + dataset.getRealEntryNumber() + "\t" + dataset.getRealEntrySize() + "\t"
                ...
                + "\t" + clockFilter.getItemNumber() + "\t" + clockFilter.getItemSize());
      }
    }
