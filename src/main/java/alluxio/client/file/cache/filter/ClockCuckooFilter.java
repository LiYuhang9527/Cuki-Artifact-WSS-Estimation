...
public class ClockCuckooFilter<T> implements Serializable {
  ...
  public ClockCuckooFilter(CuckooTable table, CuckooTable clockTable, Funnel<? super T> funnel,
      HashFunction hasher) {
    this.table = table;
  ...
  public static <T> ClockCuckooFilter<T> create(Funnel<? super T> funnel, long expectedInsertions,
