...
public class BitMapWithSlidingSketch <T>implements Serializable {
     ...
     */
    public BitMapWithSlidingSketch(int windowSize, int hashNum, int clockWidth, int bitsPerSize , Funnel<? super T> funnel){
    ...
    public static<T> BitMapWithSlidingSketch<T> create(int windowSize, int memory, int hashNum, int bitsPerSize, Funnel<?super T>funnel){
        return new BitMapWithSlidingSketch<>(windowSize,hashNum,memory/(bitsPerSize*2),bitsPerSize,funnel);
    }
